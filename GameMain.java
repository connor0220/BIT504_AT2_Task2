...
public class GameMain extends JPanel implements MouseListener {
     ...
     * player. If no winner, then isDraw is called to see if there's a deadlock. If
     * not, the GameState remains playing.
     */
    ...
    // Other mouse event methods (not used, but required by the MouseListener interface)
